...
#parto de PartidaPerfecta.feature
Feature: Pruebo la lib
...
#modelo comprobar todo 666
	...
	|     1   |
	|     1   |
        And la lista de "frases" tiene "8" elementos
        And los elementos de la lista de "frases" son:
         | id |
         | 54 |
         | 53 |
...
# ver si con avanzo se resuelve
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           |   0   |  2  |   False     |         False         |      3     |      1      |        0     |     31    |    0   |     10     |
        And la lista de "Personajes" tiene "5" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
         |    2   |  0 | Guillermo  |    0             |      1      |   56 |   57 |
         |    2   |  1 |  Adso      |     0            |      1      |   52 |   57 |
         |    2   |  3 | Abad       | __DO_NOT_CHECK__ |      2      |   61 |   55 |
         |    2   |  4 | Berengario | __DO_NOT_CHECK__ |      3      |   50 |   53 |
         |    2   |  5 | Severino   | __DO_NOT_CHECK__ |      3      |   54 |   53 |
	And la lista de "sonidos" tiene "12" elementos
        And los elementos de la lista de "sonidos" son:
	| sonando |
	|     0   |
...
# hay un señor delante
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           |   2   |  3  |   False     |         False         |      0     |     62      |        0     |     31    |    0   |     18     |
        And la lista de "Personajes" tiene "2" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
         |    2   |  0 | Guillermo  |    0             |      3      |  169 |   27 |
         |    2   |  1 |  Adso      |     2            |      3      |  169 |   25 |
	And la lista de "sonidos" tiene "12" elementos
        And los elementos de la lista de "sonidos" son:
	| sonando |
...
# manejar a Adso
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           | 4099  |  3  |   False     |         False         |      2     |     35      |        0     |     31    |    0   |     28     |
        And la lista de "Personajes" tiene "3" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
         |    4   |  0 | Guillermo  |    16            |      0      |  132 |   57 |
         |    4   |  1 |  Adso      |     2            |      1      |  132 |   59 |
         |    4   |  3 | Abad       | __DO_NOT_CHECK__ |      0      |  136 |   57 |
	And la lista de "sonidos" tiene "12" elementos
        And los elementos de la lista de "sonidos" son:
	| sonando |
	|     1   |
...
# este me quita el pergamino
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           |  4099 |  3  |   False     |         False         |      3     |     57      |        0     |     31    |    0   |     29     |
        And la lista de "Objetos" tiene "0" elementos
	And la lista de "Personajes" tiene "4" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
         |   0    |  0 | Guillermo  |    0             |      0      |  200 |   40 |
         |   0    |  1 |  Adso      |     2            |      0      |  198 |   39 |
         |   0    |  3 | Abad       | __DO_NOT_CHECK__ |      3      |  201 |   38 |
         |   0    |  6 | Jorge      | __DO_NOT_CHECK__ |      0      |  200 |   36 |
	And la lista de "sonidos" tiene "12" elementos
        And los elementos de la lista de "sonidos" son:
	| sonando |
	|     1   |
...
"""
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           | 4099  |  3  |   False     |         False         |      4     |      1      |        0     |     31    |    0   |     30     |
        And la lista de "Objetos" tiene "0" elementos
	And la lista de "Personajes" tiene "4" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
...
"""
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           |  4099 |  3  |   False     |         False         |      6     |     34      |        0     |     31    |    0   |     32     |
        And la lista de "Objetos" tiene "0" elementos
	And la lista de "Personajes" tiene "5" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
         |    2   |  0 | Guillermo  |    0             |      1      |  132 |   75 |
         |    2   |  1 |  Adso      |     3            |      1      |  132 |   78 |
         |    2   |  2 | Malaquias  | __DO_NOT_CHECK__ |      1      |  132 |   72 |
         |    4   |  3 | Abad       | __DO_NOT_CHECK__ |      3      |  136 |   60 |
         |    2   |  5 | Severino   | __DO_NOT_CHECK__ |      1      |  140 |   75 |
...
"""
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           | 4099  |  4  |   False     |         False         |      1     |     62      |        0     |     31    |    0   |     34     |
        And la lista de "Objetos" tiene "0" elementos
	And la lista de "Personajes" tiene "2" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
         |    2   |  0 | Guillermo  |    0             |      1      |  169 |   27 |
         |    2   |  1 |  Adso      |     3            |      3      |  169 |   25 |
	And la lista de "sonidos" tiene "12" elementos
        And los elementos de la lista de "sonidos" son:
	| sonando |
...
"""
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           |  4099 |  4  |   False     |         False         |      1     |     34      |        0     |     31    |    0   |     34     |
        And la lista de "Objetos" tiene "0" elementos
	And la lista de "Personajes" tiene "5" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
...
# y nos libere
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           |  4099 |  4  |   False     |         False         |      3     |      1      |        0     |     31    |    0   |     36     |
        And la lista de "Objetos" tiene "0" elementos
	And la lista de "Personajes" tiene "5" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
         ...
         |    2   |  3 | Abad       | __DO_NOT_CHECK__ |      2      |  61  |   55 |
         |    2   |  5 | Severino   | __DO_NOT_CHECK__ |      3      |  54  |   53 |
         |    2   |  7 | Bernardo   | __DO_NOT_CHECK__ |      3      |  50  |   53 |
	And la lista de "sonidos" tiene "12" elementos
        And los elementos de la lista de "sonidos" son:
	| sonando |
	|     0   |
...
"""
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           |  4099 |  4  |   False     |         False         |      6     |     34      |        0     |     31    |    0   |     39     |
        And la lista de "Objetos" tiene "0" elementos
	And la lista de "Personajes" tiene "6" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
         ...
         |    4   |  3 | Abad       | __DO_NOT_CHECK__ |      3      |  136 |   60 |
         |    2   |  5 | Severino   | __DO_NOT_CHECK__ |      1      |  140 |   75 |
         |    2   |  7 | Bernardo   | __DO_NOT_CHECK__ |      1      |  140 |   72 |
	And la lista de "sonidos" tiene "12" elementos
        And los elementos de la lista de "sonidos" son:
	| sonando |
	|     0   |
...
"""
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           | 4099  |  5  |   False     |         False         |      0     |     62      |        0     |     31    |    0   |     40     |
        And la lista de "Objetos" tiene "0" elementos
	And la lista de "Personajes" tiene "3" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
         |    2   |  0 | Guillermo  |    0             |      3      |  169 |   27 |
         |    2   |  1 |  Adso      |     3            |      3      |  169 |   25 |
         |    2   |  2 | Malaquias  | __DO_NOT_CHECK__ |      0      |  184 |   25 |
	And la lista de "sonidos" tiene "12" elementos
        And los elementos de la lista de "sonidos" son:
	| sonando |
	|     1   |
...
"""
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           | 4107  |  5  |   False     |         False         |      0     |     62      |        0     |     31    |    0   |     44     |
        And la lista de "Objetos" tiene "0" elementos
	And la lista de "Personajes" tiene "2" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
         |    2   |  0 | Guillermo  |    8             |      3      |  169 |   27 |
         |    2   |  1 |  Adso      |     3            |      1      |  169 |   29 |
	And la lista de "sonidos" tiene "12" elementos
        And los elementos de la lista de "sonidos" son:
	| sonando |
...
#	And espero "9" iteraciones
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           |  4107 |  5  |   False     |         False         |      2     |     34      |        0     |     31    |    0   |     46     |
        And la lista de "Objetos" tiene "0" elementos
	And la lista de "Personajes" tiene "3" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
         |    2   |  0 | Guillermo  |    8             |      1      |  132 |   75 |
         |    2   |  1 |  Adso      |     3            |      1      |  132 |   77 |
         |    4   |  3 | Abad       | __DO_NOT_CHECK__ |      3      |  136 |   60 |
	And la lista de "sonidos" tiene "12" elementos
        And los elementos de la lista de "sonidos" son:
...
"""
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           |  4107 |  5  |   False     |         False         |      4     |      1      |        0     |     31    |    0   |     48     |
        And la lista de "Objetos" tiene "0" elementos
	And la lista de "Personajes" tiene "3" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
         |    2   |  0 | Guillermo  |    8             |      1      |  56  |   57 |
         |    2   |  1 |  Adso      |     3            |      0      |  52  |   57 |
         |    2   |  3 | Abad       | __DO_NOT_CHECK__ |      2      |  61  |   55 |
	And la lista de "sonidos" tiene "12" elementos
        And los elementos de la lista de "sonidos" son:
...
"""
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           | 4107  |  5  |   False     |         False         |      5     |     60      |        0     |     31    |    0   |     49     |
        And la lista de "Objetos" tiene "0" elementos
	And la lista de "Personajes" tiene "3" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
         |    0   |  0 | Guillermo  |    8             |      3      |  110 |   97 |
         |    0   |  1 |  Adso      |     3            |      1      |  109 |   99 |
         |    2   |  3 | Abad       | __DO_NOT_CHECK__ |      1      |  104 |   97 |
	And la lista de "sonidos" tiene "12" elementos
        And los elementos de la lista de "sonidos" son:
	| sonando |
	|     0   |
...
"""
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           |  4107 |  5  |   False     |         False         |      6     |     34      |        0     |     31    |    0   |     50     |
        And la lista de "Objetos" tiene "0" elementos
	And la lista de "Personajes" tiene "3" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
...
"""
	...
	And los valores iniciales son correctos:
           | bonus | dia | haFracasado | investigacionCompleta | momentoDia | numPantalla | numeroRomano | obsequium | planta | porcentaje |
           | 4107  |  6  |   False     |         False         |      0     |     62      |        0     |     31    |    0   |     51     |
        And la lista de "Objetos" tiene "0" elementos
	And la lista de "Personajes" tiene "2" elementos
        And los valores de los "Personajes" son correctos:
         | altura | id | nombre     | objetos          | orientacion | posX | posY |
         |    2   |  0 | Guillermo  |    8             |      1      |  169 |   27 |
         |    2   |  1 |  Adso      |     3            |      3      |  169 |   25 |
	And la lista de "sonidos" tiene "12" elementos
        And los elementos de la lista de "sonidos" son:
	| sonando |
